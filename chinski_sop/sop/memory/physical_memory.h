...
namespace sop
{
  namespace memory
  {
    ...
    public:	
      ...
      uint8_t getFreeFrames(uint8_t pages_needed,sop::memory::LogicalMemory* table_of_pages,uint16_t pid, SwapFile* file_swap);//funkcja odpowiedzialna za przydzielenie ramek stronom, na podstawie liczby poz¹danych stron
